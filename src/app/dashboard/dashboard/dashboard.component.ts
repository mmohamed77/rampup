...
import { MemberTrainingMap } from '../../Model/memberTrainingMapping.model';
import { UpcomingTrainings } from '../../Model/upcomingTrainings.model';
...
export class DashboardComponent implements OnInit {
  ...
  navPageThird(): void {
    this.route.navigate(['training-details']);
  }

  navPageForth(): void {
    this.route.navigate(['training-mappings']);
  }
